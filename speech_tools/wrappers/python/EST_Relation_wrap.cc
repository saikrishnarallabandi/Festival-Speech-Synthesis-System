...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_EST_Relation'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    EST_Relation::EST_Relation()\n"
    "    EST_Relation::EST_Relation(char const *)\n"
    "    EST_Relation::EST_Relation(EST_Relation const &)\n");
  return 0;
}
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'EST_Relation_load'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    EST_Relation::load(EST_String const &,EST_String const &)\n"
    "    EST_Relation::load(EST_String const &)\n");
  return 0;
}
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'EST_Relation_save'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    EST_Relation::save(EST_String const &,EST_String const &,bool) const\n"
    "    EST_Relation::save(EST_String const &,EST_String const &) const\n");
  return 0;
}
